...
Elabore un Notebook estructurado como un diagnóstico preliminar y motor predictivo para María Fernanda y el comité directivo de Crédito Andino Digital. Para este ejercicio, utilice un conjunto de datos público de riesgo crediticio (dataset) [Link Dataset](https://www.kaggle.com/datasets/laotse/credit-risk-dataset).
